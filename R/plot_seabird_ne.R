  ...
  if (varName == "productivity") {
    ...
    p <- fix |>
      ...
      ggplot2::geom_errorbar(
        ggplot2::aes(x = Time, ymin = se.low, ymax = se.high),
    ...
    prey_freq1 <- fix |>
      ...
      dplyr::mutate(
        Diet = gsub("Other Invertebrate", "Unknown Invertebrate", Diet)
      )
