...
plot_energy_density <- function(shadedRegion = NULL, report = "MidAtlantic") {
  ...
  p <- d |>
    ...
    ggplot2::geom_hline(
      data = old.ed,
      ggplot2::aes(yintercept = Energy.Density_Mean, linetype = Year)
    ) +
