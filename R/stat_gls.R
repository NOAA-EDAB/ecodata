...
stat_gls <- function(mapping = NULL, data = NULL, geom = "line",
                    ...
                    inherit.aes = TRUE, ...) {
  ggplot2::layer(
    stat = soe.data:::fitGLS, data = data, mapping = mapping, geom = geom, 
