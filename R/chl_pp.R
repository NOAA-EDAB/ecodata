...
#' \url{https://noaa-edab.github.io/tech-memo/chl-pp.html}) are presented.
#' 
...
#' }
#' 
#' @details Methods used to calculate median and anomaly data are available at \url{https://noaa-edab.github.io/tech-memo/chl-pp.html}. Methods
