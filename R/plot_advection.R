...
#' @param varName Numeric scalar. Which variable (months) to plot (3 = 'March', 4 = 'April', 5 = 'May', 6 = 'June'). Can be a vector
...
attr(plot_advection, "varName") <- c(3, 4, 5, 6)
