...
plot_calanus_stage <- function(shadedRegion = NULL, report = "MidAtlantic") {
  ...
  cal <- ecodata::calanus_stage |>
    ...
    dplyr::mutate(Var = dplyr::recode(Var, "c5" = "Stage 5", "adt" = "Adult"))
  ...
  p <- cal |>
    ...
    ggplot2::scale_fill_manual(
      values = c("steelblue1", "coral1", "steelblue3", "coral3")
    ) +
