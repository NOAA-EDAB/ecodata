#' Bottom heatwaves
#'
#' Time series of annual bottom water heatwaves in the Northeast US Shelf.
#'
#'
#' @format Data contain 453 rows and 5 columns.
#' \itemize{
#'    \item Var: Cumulative and Maximum intensity of heatwaves.
