#' Expected Number of Species per 1000 Individuals
#'
...
#' }
#'
#' @details Methods used to calculate data are available at \url{https://noaa-edab.github.io/tech-doc/expected-number-of-species.html}.
"exp_n"
