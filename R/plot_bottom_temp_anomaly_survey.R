...
#'
#' @importFrom ggplot2 aes element_text theme element_rect  margin
#' @importFrom magrittr "%>%"
#'
...
plot_bottom_temp_anomaly_survey <- function(region = NULL,
  ...
  regions <- unique(ecodata::bottom_temp$EPU)
  ...
  p <- ggplot2::ggplot() +
    ...
    ggplot2::ggtitle(paste(region," Bottom temperature anomaly")) +
