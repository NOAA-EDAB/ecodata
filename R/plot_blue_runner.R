...
plot_blue_runner <- function(shadedRegion = NULL, report = "MidAtlantic") {
  ...
  blue$Var <- factor(
    blue$Var,
    levels = c("Prior to 2000", "2001-2010", "Since 2010")
  )
  ...
  p <-
    ...
    ggplot2::geom_point(
      data = blue,
      ggplot2::aes(x = Lon, y = Lat, color = Var, shape = Var)
    ) +
