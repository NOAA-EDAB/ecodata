...
seasonal_oisst_anom_nc <-"sst.day.mean.ltm.1991-2020.nc"
...
#process output
seasonal_oisst_anom8689 <- rbind(MAB,GOM,GB) %>%
...
seasonal_oisst_anom<- rbind(seasonal_oisst_anom8285, seasonal_oisst_anom8689)
write.csv(seasonal_oisst_anom, file = "SST_82_89.csv")
# load(file.path(raw.dir, "seasonal_oisst_anom.rda"))
#
