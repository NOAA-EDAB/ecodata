...
# input files ----
ppd_csv <- "19980101_20221231-OCCCI_GLOBCOLOUR-PPD-STATS_ANOMS-NES_EPU_NOESTUARIES-SOE_V2023-SOE_FORMAT.csv"
chl_csv <- "19980101_20221231-OCCCI_GLOBCOLOUR-CHLOR_A-STATS_ANOMS-NES_EPU_NOESTUARIES-SOE_V2023-SOE_FORMAT.csv"
