...
# input files ----
ppd_csv <- "19980101_20231231-OCCCI-PPD-STATS_ANOMS-NES_EPU_NOESTUARIES-SOE_PHYTOPLANKTON-SOE_FORMAT.csv"
chl_csv <- "19980101_20231231-OCCCI-CHLOR_A-STATS_ANOMS-NES_EPU_NOESTUARIES-SOE_PHYTOPLANKTON-SOE_FORMAT.csv"
