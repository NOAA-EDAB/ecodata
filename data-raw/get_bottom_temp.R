...
bottom_temp_GOM_csv<-"fratantoni_bot_temp_GOM.csv"
bottom_temp_GB_csv<-"fratantoni_bot_temp_GB.csv"
bottom_temp_MAB_csv<-"fratantoni_bot_temp_MAB.csv"
bottom_temp_SS_csv<-"fratantoni_bot_temp_SS.csv"
