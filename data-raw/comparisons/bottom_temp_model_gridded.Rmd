...
dataset24<-ecodata25::bottom_temp_model_gridded
...
ecodata25::plot_bottom_temp_model_gridded(report = report[1]) + 
...
ecodata25::plot_bottom_temp_model_gridded(report = report[2]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
