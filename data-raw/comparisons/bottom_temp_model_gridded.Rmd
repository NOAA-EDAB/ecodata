---
title: "Bottom Temperature - Model Gridded"
...
# Replace 'bottom_temp_model_gridded' with intended dataset
dataset<-ecodata::bottom_temp_model_gridded
dataset24<-ecodata25::bottom_temp_seasonal_gridded
...
ecodata::plot_bottom_temp_model_gridded(report = report[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_bottom_temp_seasonal_gridded(report = report[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_bottom_temp_model_gridded(report = report[2]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_bottom_temp_seasonal_gridded(report = report[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
