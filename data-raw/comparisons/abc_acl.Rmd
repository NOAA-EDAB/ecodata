...
ecodata25::plot_abc_acl(report = report[1],plottype = plottype[1]) + 
...
ecodata25::plot_abc_acl(report = report[2],plottype = plottype[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata25::plot_abc_acl(report = report[1],plottype = plottype[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata25::plot_abc_acl(report = report[2],plottype = plottype[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
