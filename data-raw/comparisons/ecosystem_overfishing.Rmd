...
# Replace 'ppr' with intended dataset
dataset<-ecodata::ppr
dataset24<-ecodata25::ppr

# Define dataset-specific arguments for plot functions
report<-list("MidAtlantic","NewEngland")
variable<-list("pp","fogarty","ryther")
...
ecodata::plot_ppr(report = report[1], varName = variable[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[1], varName = variable[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],variable[1])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_ppr(report = report[2], varName = variable[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[2], varName = variable[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[1],variable[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_ppr(report = report[1], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[1], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],variable[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_ppr(report = report[2], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[2], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[1],variable[3])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_ppr(report = report[1], varName = variable[3]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[1], varName = variable[3]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],variable[3])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_ppr(report = report[2], varName = variable[3]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ppr(report = report[2], varName = variable[3]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
