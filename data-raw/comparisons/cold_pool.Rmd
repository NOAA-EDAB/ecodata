...
ecodata25::plot_cold_pool(report = report[1],varName = variable[1], n = 10) + 
...
ecodata25::plot_cold_pool(report = report[1],varName = variable[2], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata25::plot_cold_pool(report = report[1],varName = variable[3], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
