...
# Replace 'long_term_sst' with intended dataset
dataset<-ecodata::long_term_sst
dataset24<-ecodata25::long_term_sst
...
ecodata::plot_long_term_sst(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_long_term_sst(report = report[1], n = 10) + 
