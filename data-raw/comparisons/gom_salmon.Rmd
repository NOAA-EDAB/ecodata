---
title: "Gulf of Maine Atlantic Salmon"
...
# Replace 'gom_salmon' with intended dataset
dataset<-ecodata::gom_salmon
dataset24<-ecodata25::gom_salmon
...
ecodata::plot_gom_salmon(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_gom_salmon(report = report[1], n = 10) + 
