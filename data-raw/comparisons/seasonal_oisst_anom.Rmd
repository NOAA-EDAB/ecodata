...
ecodata25::plot_seasonal_oisst_anom(report = report[1], n = 10) + 
...
ecodata25::plot_seasonal_oisst_anom(report = report[2], EPU = epu[1], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata25::plot_seasonal_oisst_anom(report = report[2], EPU = epu[2], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
