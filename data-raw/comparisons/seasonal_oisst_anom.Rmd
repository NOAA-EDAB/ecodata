...
dataset24<-ecodata24::seasonal_oisst_anom
...
ecodata24::plot_seasonal_oisst_anom(report = report[1]) + 
...
ecodata24::plot_seasonal_oisst_anom(report = report[2], EPU = epu[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata24::plot_seasonal_oisst_anom(report = report[2], EPU = epu[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
