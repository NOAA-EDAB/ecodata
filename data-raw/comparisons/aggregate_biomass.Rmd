---
title: "Aggregate Survey Biomass"
...
# Replace 'aggregate_biomass' with intended dataset
dataset<-ecodata::aggregate_biomass
dataset24<-ecodata25::aggregate_biomass
...
ecodata::plot_aggregate_biomass(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_aggregate_biomass(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],epu[1])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_aggregate_biomass(report = report[2], EPU = epu[1], n = 10) +
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_aggregate_biomass(report = report[2], EPU = epu[1], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```

## `r paste(report[2],epu[2])`
```{r, fig.show="hold", out.width="50%", echo=FALSE, message=FALSE, warning=FALSE}
ecodata::plot_aggregate_biomass(report = report[2], EPU = epu[2], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_aggregate_biomass(report = report[2], EPU = epu[2], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
