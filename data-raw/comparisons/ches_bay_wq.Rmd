---
title: "Chesapeake Bay Water Quality"
...
# Replace 'ches_bay_wq' with intended dataset
dataset<-ecodata::ches_bay_wq
dataset24<-ecodata25::ches_bay_wq
...
ecodata::plot_ches_bay_wq(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_ches_bay_wq(report = report[1]) + 
