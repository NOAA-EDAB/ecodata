...
dataset24<-ecodata25::seasonal_sst_anomaly_gridded
...
ecodata25::plot_seasonal_sst_anomaly_gridded(report = report[1]) + 
...
ecodata25::plot_seasonal_sst_anomaly_gridded(report = report[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
