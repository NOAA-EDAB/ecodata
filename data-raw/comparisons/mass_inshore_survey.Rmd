---
title: "Massachusetts Inshore Survey"
...
# Replace 'mass_inshore_survey' with intended dataset
dataset<-ecodata::mass_inshore_survey
dataset24<-ecodata25::mass_inshore_survey

# Define dataset-specific arguments for plot functions
report<-list("NewEngland")
#variable<-list()
...
ecodata::plot_mass_inshore_survey(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_mass_inshore_survey(report = report[1], n = 10) + 
