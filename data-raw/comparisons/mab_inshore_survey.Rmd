---
title: "NEAMAP (MAB Inshore Survey)"
...
# Replace 'mab_inshore_survey' with intended dataset
dataset<-ecodata::mab_inshore_survey
dataset24<-ecodata25::mab_inshore_survey
...
dataset24$Value<-as.numeric(dataset24$Value)
...
ecodata::plot_mab_inshore_survey(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2026") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata25::plot_mab_inshore_survey(report = report[1], n = 10) + 
