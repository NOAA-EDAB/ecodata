...
# Replace 'hudson_river_flow' with intended dataset
dataset<-ecodata::hudson_river_flow
dataset24<-ecodata24::hudson_river_flow
...
ecodata::plot_hudson_river_flow(report = report[1], n = 10) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_hudson_river_flow(report = report[1]) + 
