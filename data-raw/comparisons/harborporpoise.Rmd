...
# Replace 'harborporpoise' with intended dataset
dataset<-ecodata::harborporpoise
dataset24<-ecodata24::harborporpoise
...
ecodata::plot_harborporpoise(report = report[1]) + 
  ggplot2::ggtitle("SOE 2025") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))

ecodata24::plot_harborporpoise(report = report[1]) + 
