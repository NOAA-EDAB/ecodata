...
ecodata24::plot_exp_n(report = report[1], varName = variable[1]) + 
...
ecodata24::plot_exp_n(report = report[2], varName = variable[1]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata24::plot_exp_n(report = report[1], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
...
ecodata24::plot_exp_n(report = report[2], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
