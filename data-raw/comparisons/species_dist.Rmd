...
dataset24<-ecodata24::species_dist
...
ecodata24::plot_species_dist(report = report[1], varName = variable[1]) + 
...
ecodata24::plot_species_dist(report = report[1], varName = variable[2]) + 
  ggplot2::ggtitle("SOE 2024") + ggplot2::theme(plot.title = ggplot2::element_text(size = 20))
```
