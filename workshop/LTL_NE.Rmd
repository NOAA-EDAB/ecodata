...
ecodata::plot_chl_pp(c(2014,2023), report = "NewEngland", varName = "chl")

ecodata::plot_chl_pp(c(2014,2023), report = "NewEngland", varName = "pp")
...
ecodata::plot_phyto_size(c(2014,2023), report = "NewEngland", EPU = "GB")
ecodata::plot_phyto_size(c(2014,2023), report = "NewEngland", EPU = "GOM")
...
```{r zoo-euph-cnid, fig.width = 8, fig.cap="Abundance Anomalies of cnidarians and euphausiids in Mid-Atlantic Bight."}
...
```{r heatwave-gb, fig.cap="Marine heatwave duration (left) and maximum intensity (right) in the Georges Bank."}
...
```{r heatwave-gom, fig.cap="Marine heatwave duration (left) and maximum intensity (right) in the Gulf of Maine."}
...
```{r bottom-heatwave-gom, fig.cap="Bottom heatwave duration (left) and maximum intensity (right) in Gulf of Maine."}
hw1<- ecodata::heatwave %>%
  dplyr::filter(Time >= 2021) %>% 
  dplyr::mutate(Source = c("PSY"))
hwts<- ecodata::heatwave %>% 
