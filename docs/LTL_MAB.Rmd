...
```{r sumlength,  fig.cap="Annual number of days between srping and fall transition dates"}
ecodata::trans_dates %>% 
  dplyr::filter(EPU == "MAB", 
                Var %in% c("sumlen30"), 
                !Value == "NA") %>% 
...
```{r zoo-euph-cnid, fig.cap="Abundance Annomalies of cnidarians and euphausiids in Mid-Atlantic Bight."}
