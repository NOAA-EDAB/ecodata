...
```{r bottom-heatwave, fig.cap="Bottom heatwave cumulative intesity (left) and maximum intensity (right) in the Mid-Atlantic Bight."}
...
ecodata::habitat_diversity %>% 
  ...
  ggplot2::ylab("") +
  ggplot2::xlab(element_blank())+
  ggplot2::ggtitle("Mid-Atlantic Habitat Richness") +
  ggplot2::scale_x_continuous(expand = c(0.01, 0.01))+
  ggplot2::geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
...
ecodata::habitat_diversity %>% 
  ...
  ggplot2::ylab("") +
  ggplot2::xlab(element_blank())+
  ggplot2::ggtitle("Mid-Atlantic Habitat Shannon Diversity") +
  ggplot2::scale_x_continuous(expand = c(0.01, 0.01))+
  ggplot2::geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
