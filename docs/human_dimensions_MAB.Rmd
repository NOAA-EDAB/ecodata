...
```{r commercial-EJ2, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index)  ", fig.asp=1}
...
```{r recreational-EJ2, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index)  ", fig.asp=1}
p1<- ecodata::engagement %>%
  dplyr::filter(Region == "MAB",
                Fishery == "Recreational") %>%
  dplyr::arrange(desc(Eng)) %>% 
