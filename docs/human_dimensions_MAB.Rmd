...
```{r commercial-engagement, message=F, fig.cap= "Commercial engagement and reliance for the top top commercial fishing communities in the Mid-Atlantic. (* Scored high (1.00 and above) for both commercial engagement and reliance indicators)", message = FALSE, warning=FALSE}
...
fmsb::radarchart(p3[,c(1, 14:2)], xpd = TRUE,
...
legend(x="top",legend = rownames(p3[-c(1,2),]), bty = "n",  pch=20 , horiz = TRUE, 
...
```{r recreational-engagement, message=F, fig.cap= "Recreational engagement and reliance for the top top recreational fishing communities in the Mid-atlantic. (* Scored high (1.00 and above) for both recreational engagement and reliance indicators)"}
...
```{r wind-port, fig.cap="Total (left) and percent(right) of port revenue from Wind Energy Areas(WEA) in descending order of most to least total port revenue."}
