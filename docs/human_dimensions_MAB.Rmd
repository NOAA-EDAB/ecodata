...
```{r aquaculture, fig.width = 5, fig.asp = 0.45, fig.cap = "Oyster aquaculture production in terms of number of oysters sold from Virginia, Maryland, and New Jersey. \\label{oyster-aqua}"}
...
```{r commercial-engagement, message=F, fig.cap= "Commercial engagement and reliance for the top top commercial fishing communities in the Mid-Atlantic."}
...
gridExtra::grid.arrange(
  gridExtra::tableGrob(labels, theme = gridExtra::ttheme_minimal(base_size = 6)),
  total_area, dist_area, foundations,
  ncol = 2,
  widths = c(1, 1),
  clip = FALSE
)
