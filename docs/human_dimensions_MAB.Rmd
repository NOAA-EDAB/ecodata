...
```{r commercial-EJ, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index)  "}
...
```{r recreational-EJ, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index)  "}
p1<- ecodata::engagement %>%
  dplyr::filter(Region == "MAB",
                Fishery == "Recreational") %>%
  dplyr::select(Community, PDI ,
