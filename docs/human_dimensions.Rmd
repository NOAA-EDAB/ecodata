...
```{r bennet, fig.cap = paste0("Revenue change from the 2015 values in dollars (black), Price (PI), and Volume Indicators (VI) for commercial landings in the Mid-Atlantic Bight. \\label{bennet}"), fig.width = 6, fig.asp = 0.45}
...
```{r rec-landings, fig.cap = paste0("Total recreational landings in the ",region," region. \\label{rec-landings}"), fig.width = 5, fig.asp = 0.45}
...
```{r bennet-ne, fig.cap = paste0("Revenue change from the long-term mean in 2015 dollars (black), Price (PI), and Volume Indicators (VI) for commercial landings in Georges Bank (left) and Gulf of Maine (right). \\label{bennet}"), fig.height = 3, fig.width=8}
...
```{r comm-revenue-ne, fig.cap = "Total commercial revenue (black) and revenue from NEFMC managed species (red) in Georges Bank (left) and Gulf of Maine (right). \\label{comm-rev}", fig.width = 8, fig.asp = 0.35}
...
```{r rec-landings-ne, fig.cap = paste0("Total recreational landings in ",region,". \\label{rec-landings}"), fig.width = 5, fig.asp = 0.45}
