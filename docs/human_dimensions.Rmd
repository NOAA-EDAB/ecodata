...
```{r bennet-ne, fig.cap = paste0("Revenue change from the long-term mean in 2015 dollars (black), Price (PI), and Volume Indicators (VI) for commercial landings in Georges Bank (left) and Gulf of Maine. \\label{bennet}"), fig.height = 3, fig.width=8}
...
```{r, eval = T, echo = F, fig.cap="Map of BOEM lease areas  as of feb 2019.", message=FALSE, results=FALSE}
