...
```{r comm_landings, warning=F, , fig.cap = ("MAFMC managed species landings (red) and total commercial landings (black) by feeding guild. \\label{comm-landings}")}
...
```{r comm_landings-ne, warning=F, fig.length = 16, fig.cap = "NEFMC managed species landings (red) and total commercial landings (black) by feeding guild in Gulf of Maine (left) and Georges Bank (right)."}
