...
# bathy<- raster(file.path(gis.dir, 'NES_bathymetry.tif'))
# e <- c(-79,-69,34,43)
# bathyMA <- crop(bathy,e)
# bathy_df <- as.data.frame(bathyMA, xy = TRUE) 
# 
...
# 
# ggplot() +
#   geom_raster( data = bathy_df, aes(x=x,y=y), fill = NES_bathymetry) +
#   geom_sf(data = epu_shp, size = map.lwd, alpha = 0.5)+
