...
```{r seasonal-sst-anomaly-gridded, fig.width=8, fig.height = 8, fig.cap="GB and GOM 2019 seasonal sea surface temperature spatial anomalies. "}
#EPU shapefile
...
style="color: red;">NOT UPDATED</span>
...
style="color: red;">ONLY CALANUS sTAGE IS NEW</span>
...
gom_map <- 
  ...
  ggplot2::geom_sf(data = ecodata::coast, size = map.lwd) +
  ggplot2::geom_sf(data = ne_epu_sf, fill = "transparent", size = map.lwd) +
  ggplot2::scale_fill_gradientn( colours = c(scales::muted("blue"), "white", scales::muted("red"), "black"),
