...
### Protected species 
<span style="color: red;">NO NEW DATA - No bycatch data this year</span>
...
```{r grayseal, fig.cap="5 year Gray Seal bycatch estimate for NEUS Shelf (Blue) and 1 Year estimate for New England (Black) and the potential biological removal (red)." }
...
```{r grayseal-mab, fig.cap="5 year Gray Seal bycatch estimate for NEUS Shelf (Blue) and and the potential biological removal (red)." }
...
```{r NARW-calf-abundance, fig.cap = "Number of North Atlantic right whale calf births, 1990 - 2021."}
...
```{r hms-dist-shifts, fig.cap = "Species distribution shifts between 2010 and 2017." }
