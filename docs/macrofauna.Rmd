...
#Image Directory
image.dir <- here::here("image/2020")
...
<p style="color:red">Not submitting for 2020.</p>
<!---
...
### Condition factor
Still working on color scale - hopefully picking color scale that passes through gray/white
...
#### GB
```{r gb-cf, fig.cap = "Condition factor for NEFMC and jointly managed species."}
image.dir <- here::here("docs")
...
#### GOM
```{r gom-cf, fig.cap = "Condition factor for NEFMC and jointly managed species."}
image.dir <- here::here("docs")
