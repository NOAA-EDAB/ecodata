...
<p style="color:red">Not updated - no new dataset. Follow up Charles Peretti</p>
...
knitr::include_graphics(file.path(image.dir, "MAB_condition_2019.jpg"))
...
[Maybe best as narrative] (https://ccbbirds.org/wp-content/uploads/CCBTR-19-06_Colonial-waterbirds-in-coastal-Virginia-2018.pdf) - well documented decline in birds in last 20 years.
...
<p style="color:red">Not Updated - data from Rebecca Peters?</p>
...
knitr::include_graphics(file.path(image.dir, "GB_condition_2019.jpg"))
...
knitr::include_graphics(file.path(image.dir, "GOM_condition_2019.jpg"))
...
#### NARW
```{r right_whale, eval = T, echo = F, out.width="100%"}
image.dir <- here::here("docs")
knitr::include_graphics(file.path(image.dir, "narw.png"))
...
<p style="color:red">Not updated data goes through 2018. Data from Kevin</p>
...
### Habitat occupency model summer flounder
```{r hab-occup, fig.cap = "Summer Flounder habitat occupency model.", out.width="100%"} 
image.dir <- here::here("docs")
knitr::include_graphics(file.path(image.dir, "hab_occupency.png"))
