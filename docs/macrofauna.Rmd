...
```{r tern-diet-diversity, fig.cap = "Evenness and Shannon diversity of common tern diets observed at seven different islands in Gulf of Maine. Diversity of common tern diets has been predominantly above the long-term mean since 2006.",fig.width = 5, fig.asp = 0.55}
