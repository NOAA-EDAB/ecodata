...
```{r VA-cote, fig.cap = "Estimated number of breeding pairs in Virginia barier island/lagoon system. Values fom ",fig.width = 5, fig.asp = 0.55 }
...
```{r gb-biomass-ne, fig.cap = paste0("Spring (left) and fall (right) NEFSC surveyed biomass in Georges Bank."), fig.width=8, fig.asp = 0.75}
...
```{r MA-inshore, fig.width=8, fig.asp = 0.75, fig.cap = "Spring (left) and fall (right) surveyed biomass from the Massachusetts state inshore bottom trawl survey."}
...
### Productivity anomaly
```{r GB-productivity, fig.cap = "Small fish per large fish biomass anomaly in Georges Bank.",fig.width = 8, fig.height = 5}
...
```{r GOM-productivity, fig.cap = "Small fish per large fish biomass anomaly in the Gulf of Maine.",fig.width = 8, fig.height = 5}
...
```{r NARW-abundance, fig.width = 6, fig.asp = 0.55,fig.cap = "Estimated North Atlanic right whale abundance on the Northeast Shelf."}
