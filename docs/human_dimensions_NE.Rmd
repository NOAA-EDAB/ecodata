...
<!-- ```{r commercial-EJ2, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index)- Use Changhua's version below  ", fig.asp=1} -->
...
<!--                 PCI, PI)  %>% -->
<!--   dplyr::rename("PovertyIndex" = PI,  -->
<!--                 "PersonalDistributionIndex" = PDI,  -->
<!--                 "PopulationCompositionIndex" = PCI) %>%  -->
...
<!-- fmsb::radarchart(p3[,c(1, 17:2)], xpd = TRUE, -->
...
<!-- legend(x="top",legend = rownames(p3[-c(1,2),]),  -->
<!--        bty = "n",  pch=20 ,horiz = TRUE, -->
...
<!-- ```{r recreational-EJ2, fig.cap="Environmental Justice indiciators (PDT =Personal Disruption Index, PCI =Population Composition Index, PI = Poverty Index) - Use Changhua's version below", fig.asp=1} -->
<!-- p1<- ecodata::engagement %>% -->
<!--   dplyr::filter(Region == "NE", -->
<!--                 Fishery == "Recreational") %>% -->
<!--   dplyr::arrange(desc(Eng)) %>%  -->
...
knitr::include_graphics(file.path(image.dir, "EJ_Recreational_NE.png"))
...
|-----------------------|--------|-----------|------------------|
|Atlantic Herring       |ACL     |2017-2022  |Catch|
|Groundfish             |ACL     |2013-2022  |Catch|
|Sea Scallop            |ACL     |2012-2022  |Landings|
|Monkfish               |TAL     |2009-2022  |Landings|
|Skate                  |Wing TAL|2013-2022  |Landings|
|Small Mesh Multispecies|TAL     |2019-2022  |Landings|
|Red Crab               |ABC     |2012-2022  |Landings|
|Spiny Dogfish          |ABC     |2019-2022  |Landings|
...
```{r abcacl-catch, fig.cap = "Catch divided by Quota(ABC/ACL/TAL) for NEFMC managed fisheies. "}
