...
```{r comdat-commercial-landings-gb, warning=F, fig.length = 24, fig.cap = "NEFMC managed seafood landings from US (red) and total  landings (black) by feeding guild in Georges Bank."}
#Managed landings
...
```{r comdat-commercial-landings-gom, warning=F, fig.length = 24, fig.cap = "NEFMC managed seafood landings in US (red) and total  landings (black) by feeding guild in Gulf of Maine."}
