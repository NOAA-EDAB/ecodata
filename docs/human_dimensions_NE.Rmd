...
```{r commercial-engagement, message=F, warning = FALSE, fig.cap= "Commercial engagement and reliance for the top top commercial fishing communities in New England. (* Scored high (1.00 and above) for both commercial engagement and reliance indicators)"}
...
```{r commercial-EJ, fig.cap="Environmental Justice indiciators "}
...
```{r recreational-engagement, message=F, warning = FALSE, fig.cap= "Recreational engagement and reliance for the top top recreational fishing communities in New England. (* Scored high (1.00 and above) for both recreational engagement and reliance indicators)"}
