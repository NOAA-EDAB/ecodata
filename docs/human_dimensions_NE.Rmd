...
```{r comdat-commercial-landings-gb, warning=F, fig.length = 24, fig.cap = "NEFMC managed species landings from US (red) and total commercial landings (black) by feeding guild in Georges Bank (right)."}
#Managed landings
...
```{r comdat-commercial-landings-gom, warning=F, fig.length = 24, fig.cap = "NEFMC managed species landings in US (red) and total commercial landings (black) by feeding guild in Gulf of Maine."}
...
```{r hms-commercial-landings, warning=F, fig.length = 24, fig.cap = "HMS groups include “Bluefin Tuna”, “BAYS”, “Swordfish”, “Large Coastal Sharks”, “Small Coastal Sharks”, “Pelagic Sharks”, “Smoothhound Sharks”. “BAYS” includes bigeye, albacore, yellowfin and skipjack tunas. “Smoothhound Sharks” includes smooth dogfish shark."}
...
```{r comdat-total-landings, fig.cap = paste0("Total commercial landings (black), total US landings (blue), and  NEFMC managed seafood landings from US (red) in Gulf of Maine (left) and Georges Bank (right). \\label{total-landings}")}
council_abbr <- "NEFMC"
#Managed landings
managed_landings <- ecodata::comdat  %>%
  dplyr::filter(stringr::str_detect(Var, "US only"),
...
series.col <- c("indianred",  "black", "blue")
...
```{r commercial-engagement, message=F, warning = FALSE, fig.cap= "Commercial engagement, reliance and environmental vulnerability for the top commercial fishing communities in New England. (* Scored high (1.00 and above) for both commercial engagement and reliance indicators)"}
...
```{r commercial-EJ, fig.cap="Environmental justice indicators (Poverty Index, population composition index, and personal disruption index) for top commercial fishing communities in New england."}
...
```{r aquaculture, fig.cap = "Oyster aquaculture production in terms pieces, lease area and production by acre through 2020. \\label{oyster-aqua}"}
...
```{r recreational-engagement, message=F, warning = FALSE, fig.cap= "Recreational engagement, reliance and vulnerability for the top  recreational fishing communities in New England. (* Scored high (1.00 and above) for both recreational engagement and reliance indicators). "}
...
```{r recreational-EJ, fig.cap="Environmental justice indicators (Poverty Index, population composition index, and personal disruption index) for top recreational fishing communities in New england."}
...
```{r wea-spp-rev, fig.cap="Wind energy revenue in the New England"}
...
|Fishery                |Quota   |Year Range |Catch vs Landings |
|-----------------------|--------|-----------|------------------|
|Atlantic Herring       |ACL     |2013-2020  |Grand Total Catch |
|Groundfish             |ACL     |2010-2021  |Grand Total Catch |
|Sea Scallop            |ACL     |2011-2020  |Grand Total Catch |
|Monkfish               |ACL     |2011-2020  |Grand Total Catch |
|Skate                  |TAL     |2013-2022  |Catch             |
|Small Mesh Multispecies|ACL     |2010-2021  |Grand Total Catch |
|Red Crab               |ACL     |2013-2019  |Grand Total Catch |
|Spiny Dogfish          |ACl     |2013-2020  |Grand Total Catch |

```{r abcacl-stacked, fig.cap="* use TAL - just skates"}
...
```{r abcacl-catch, fig.cap = "Catch divided by Quota(ACL) for NEFMC managed fisheies. * = TAL "}
