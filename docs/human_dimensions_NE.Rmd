...
```{r wind-port, fig.cap="Total (left) and percent (right) of New England port revenue and social vulnerability indicators from wind energy areas."}
...
### Total ABC/ACL
```{r abc-acl, fig.cap = "Catch divided by ABC/ACL for MAFMC managed fisheies. Chub mackerel removed due extremely low catch. Outliers = Recreational Black Sea Bass.  Possible management success story? - See comment in google doc."}
...
```{r wind-proposed-dev, eval = T, echo = F, fig.cap='', out.width='80%'}
