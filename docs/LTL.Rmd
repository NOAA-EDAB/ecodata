...
Kevin to deliver in mid Dec when data is posted. 
...
<p style="color:red">No data delivered</p>
...
Narrative from Bruce Vogt - short write up on anomalies in salinity we saw this year following record breaking rain in 2018.  The low salinities impacted hypoxia, fish and oysters. 
...
p1 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"MAB_Heatwave_Cumul.jpg"))
p2 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"MAB_Heatwave_Max.jpg"))
...
<p style="color:red">Primary production anom  -  Not Updated</p>
...
p1 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"GOM_Heatwave_Cumul.jpg"))
p2 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"GOM_Heatwave_Max.jpg"))

cowplot::plot_grid(p1, p2)
```

```{r GOM_heatwave1, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")
...
#### GB
```{r GB_heatwave, eval= T, echo = F}

image.dir <- here::here("docs")


p1 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"GB_Heatwave_Cumul.jpg"))
p2 <- cowplot::ggdraw() + cowplot::draw_image(file.path(image.dir,"GB_Heatwave_Max.jpg"))

cowplot::plot_grid(p1, p2)
```

```{r GB_heatwave1, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")
...
### NERRs water quality 
Megan worked up one station as an example will do the rest if we decide it will be included. (https://docs.google.com/document/d/1WFPJV7vvgXbDisLK24j75kzGbxkLU8-oiSWiCGYxKNk/edit)

```{r NERRs-map, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")

knitr::include_graphics(file.path(image.dir,"NERRs_Map.jpg"))
```

```{r NERRs-chla, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")

knitr::include_graphics(file.path(image.dir,"NERRs_Chla.png"))
```

```{r NERRs-MP-DIN, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")

knitr::include_graphics(file.path(image.dir,"NERRs_MP_DIN.png"))
```

```{r NERRs-MH-DIN, eval= T, echo = F, out.width = "80%"}
image.dir <- here::here("docs")

knitr::include_graphics(file.path(image.dir,"NERRs_MH_DIN.png"))
```
