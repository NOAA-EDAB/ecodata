...
#### Small-large index
<p style="color:red">PPD anom not updated.</p>
...
<p style="color:red">Data from Harvey only goes through 2017??.</p>
...
#### OI abundance
<p style="color:red">Not Updated. Technical difficulties</p>
...
hline <- mean(cumu$Value)
cumu %>% 
  ggplot() +
  geom_line(aes(x = Time, y = Value)) +
  geom_point(aes(x = Time, y = Value)) +
  geom_gls(aes(x = Time, y = Value)) +
  ylab("Cumulative intesity (degrees C x days)") +
  ggtitle("Marine Heatwave Cumulative Intesity") +
  scale_x_continuous(expand = c(0.01, 0.01))+
  geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
...
maxin <- ecodata::heatwave %>% 
  ...
  ungroup()
hline <- mean(maxin$Value)
maxin %>% 
  ggplot() +
  geom_line(aes(x = Time, y = Value)) +
  geom_point(aes(x = Time, y = Value)) +
  geom_gls(aes(x = Time, y = Value)) +
  ylab("Maximum intesity (degrees C)") +
  ggtitle("Marine Heatwave Maximum Intesity") +
  scale_x_continuous(expand = c(0.01, 0.01))+
  geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
...
cumu %>% 
  ...
  geom_gls(aes(x = Time, y = Value)) +
  ylab("Cumulative intesity (degrees C x days)") +
  ggtitle("Marine Heatwave Cumulative Intensity") +
  scale_x_continuous(expand = c(0.01, 0.01))+
  geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
...
maxin %>% 
  ...
  geom_gls(aes(x = Time, y = Value)) +
  ylab("Maximum intesity (degrees C)") +
  ggtitle("Marine Heatwave Maximum Intensity") +
  scale_x_continuous(expand = c(0.01, 0.01))+
  geom_hline(aes(yintercept = hline),
           size = hline.size,
           alpha = hline.alpha,
...
<p style="color:red">Potentially possible to get map like this for DO, chl and nitrogen. </p>
