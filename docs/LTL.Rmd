...
sst_map + 
  annotation_custom2(grob = winter_anom,  xmin=-82, xmax=-74,
                     ymin=39, ymax=43, data = data.frame(Season = "Winter")) +
  annotation_custom2(grob = spring_anom,  xmin=-82, xmax=-74,
                     ymin=39, ymax=43, data = data.frame(Season = "Spring")) +
  annotation_custom2(grob = summer_anom,  xmin=-82, xmax=-74,
                     ymin=39, ymax=43, data = data.frame(Season = "Summer")) +
  annotation_custom2(grob = fall_anom,  xmin=-82, xmax=-74,
                     ymin=39, ymax=43, data = data.frame(Season = "Fall"))
