...
These data contain time series of inshore (within 12 miles)
...
A data set containing 264 rows and 6 columns.
...
- EPU: Ecological Production Unit (EPU) where sampling occurred. Here
