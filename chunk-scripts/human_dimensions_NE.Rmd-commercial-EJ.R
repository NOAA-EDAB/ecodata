...
fmsb::radarchart(p3, 
                 pcol=colors_border , plwd=2 , plty=1, caxislabels=c(0, 0.25, 0.5, 0.75, 1),
                 cglcol="grey", cglty=1, axislabcol="black", cglwd=0.7,
                 vlcex=0.6, title = "Environmental Justice Vulnerabilty New England Commercial Communities" )
legend(x=1.5, y=1, legend = rownames(p3[-c(1,2),]), bty = "n", pch=20 ,
      col = colors_border, text.col = "black", cex=0.6, pt.cex=1)
