...
test_that("'plot_wcr' has valid default arguments", {
  expect_no_error(invisible(ecodata::plot_wcr()))
})

# Test that the plot function creates an object
test_that("'plot_wcr' creates an object", {
...
test_that("'plot_wcr' has user-defined attributes", {
  ...
  expect_no_match(
    names(attributes(ecodata::plot_wcr)),
    "srcref",
    all = FALSE
  )
})
...
test_that("'plot_wcr' all argument combinations work", {
